...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.presenterFactory, nette.mailer, nette.database, ProjectsModel, EventsModel, UsersModel, authenticator, container,
		...
		'models\\basemodel' => FALSE, //: ProjectsModel, EventsModel, UsersModel,
